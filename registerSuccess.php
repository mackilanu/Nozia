           	...
           	<div class="container">
               	<div class="row">
                   	<div class="col-md-12">
                       	...
                       	<h1 id="title" size><font size="20">Tack för din registrering!</font></h1>
                       	<p>När du har verifierat ditt konto kan du logga in och ta del av alla fantastiska erbjudanden hos NOZIA. VI hoppas att du får en fantastisk upplevelse med oss!</p>
