    ...
    <div id="navbarCollapse" class="collapse navbar-collapse">
        ...
        <form role="search" class="navbar-form navbar-left" >
            ...
            <div class="form-group">
              ...
              <h1 id="welcome-message">NOZIA</h1>

              <a href="../includes/logout.php" style="color: #FFF; margin-right: 10px">Logga ut</a>
              <a href="/mittkonto" style="color: #FFF;">Min profil</a>
       ...
       <a href="/kategorier"><img src="../img/whiteLogo.png" width="100" height="100" align="rigth"></a>
